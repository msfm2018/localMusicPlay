...
{$ENDIF}
  ...
  public
    ...
    procedure Pack(all: boolean);
    property Lengthx: integer read FLength;
...
begin
  case ObjectGetType(FObj) of
    ...
    stArray:
      begin
        Inc(FCount);
        if FCount < FObj.AsArray.Lengthx then
          Result := true
        else
          Result := false;
      end;
      ...
      tsMethodPut:
        begin
          ...
          case v of
            ...
            ')':
              begin
                if TokRec^.Obj.AsArray.Lengthx = 1 then
...
var
  ...
  begin
    ...
    case ObjectGetType(enum) of
      stArray:
        for I := 0 to enum.AsArray.Lengthx - 1 do
              ...
              begin
                ...
                if sequence <> nil then
                  case ObjectGetType(sequence) of
                    stObject:
                      begin
                        for I := 0 to O.AsArray.Lengthx - 1 do
                ...
                Result := Result and CheckLength(O.AsArray.Lengthx, p, objpath);
...
begin
  ...
  try
    ...
    if ObjectIsType(defs, stArray) then
      for j := 0 to defs.AsArray.Lengthx - 1 do
